<script lang="ts">
	...
	async function handleLogin(event: SubmitEvent) {
		...
		try {
			...
			// Ensure returnTo has base path
			const finalReturnTo = returnTo.startsWith(base) ? returnTo : `${base}${returnTo}`;
			goto(finalReturnTo);
		} catch (err: any) {
		...
		<Card>
			...
			<div class="auth-form">
				...
				>
					...
					<span>{isGoogleSignInInProgress ? 'Signing in...' : 'Continue with Google'}</span>
				</button>
				...
				<div class="auth-links">
					<a href={`${base}/forgot-password`} class="link">Forgot password?</a>
					<span class="separator">•</span>
					<a href={`${base}/register`} class="link">Create an account</a>
				</div>
			</div>
		</Card>
	</div>
